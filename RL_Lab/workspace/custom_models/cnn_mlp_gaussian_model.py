...
from custom_models.cnn_mp_mlp import cnn_mp_mlp

class CnnMpGaussianMlp_Model(Model):
    """Gaussian MLP Model.
    ...
    def __init__(self,                 
                 ...
                 std_hidden_w_init=tf.initializers.glorot_uniform(seed=deterministic.get_tf_seed_stream()),
                 std_hidden_b_init=tf.zeros_initializer(),
                 std_output_nonlinearity=None,
                 std_output_w_init=tf.initializers.glorot_uniform(seed=deterministic.get_tf_seed_stream()),
    ...
    def _build(self, state_input, name=None):
        ...
        with tf.compat.v1.variable_scope('dist_params'):
            if self._std_share_network:
                ...
                mean_std_network = cnn_mp_mlp(input_var_cnn=state_input,
