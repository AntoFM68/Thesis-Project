...
from custom_models.cnn_mlp_gaussian_model import CnnMpGaussianMlp_Model


# pylint: disable=too-many-ancestors
class ContinuousGaussianCnnMlpPolicy(CnnMpGaussianMlp_Model, Policy):
    ...
    def __init__(self,
                 ...
                 name='ContinuousGaussianCnnMpMlpPolicy',
    ...
    def clone(self, name):
        ...
        """
        new_policy = self.__class__(name=name,
